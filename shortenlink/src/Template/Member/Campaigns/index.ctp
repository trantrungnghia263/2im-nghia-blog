        ...
        <table class="table table-hover table-striped">
            ...
            <?php foreach ($campaigns as $campaign): ?>
                <tr>
                    ...
                    <td><?= $this->Html->link($campaign->name, array('controller' => 'Campaigns', 'action' => 'view', $campaign->id));?></td>
                    ...
                    <td>
                        ...
                        <?php if (6 == $campaign->status) : ?>
                            <?= $this->Html->link(__('Pay'), ['action' => 'pay', $campaign->id], ['class' => 'btn btn-success btn-xs']); ?>
                        <?php endif; ?>
