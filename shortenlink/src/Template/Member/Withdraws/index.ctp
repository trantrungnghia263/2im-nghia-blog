...
<div class="row">
    <div class="col-sm-4">
        <div class="small-box bg-aqua">
            <div class="inner">
                <h3><?= display_price_currency($user->publisher_earnings); ?></h3>
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __("When your account reaches the minimum amount of {0} or more, you may request your earnings by clicking the above button. The payment is then sent to your PayPal account during business days no longer than 4 days after requesting. Please do not contact us regarding payments before due dates.", display_price_currency(get_option('minimum_withdrawal_amount', 5))) ?></p>

        <p><?= __('In order to receive your payments you need to fill your payment method and payment ID <a href="{0}">here</a> if you haven\'t done so. You are also requested to fill all the required fields in the Account Details section with accurate data.', $this->Url->build([ 'controller' => 'Users', 'action' => 'profile', 'prefix' => 'member']) ) ?></p>
