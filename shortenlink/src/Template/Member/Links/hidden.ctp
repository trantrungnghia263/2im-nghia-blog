...
<?php foreach ($links as $link): ?>
    ...
    <div class="box box-solid">
        <div class="box-body">
            ...
            <p class="text-muted">
                <small><i class="fa fa-calendar"></i> <?= display_date_timezone($link->created); ?> - <a target="_blank" href="<?= $link->url ?>"><?= strtoupper(parse_url($link->url, PHP_URL_HOST)); ?></a></small>
            </p>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="text-right">
                        ...
                        <?= $this->Form->postLink(__('Unhide'), ['action' => 'unhide', $link->alias], ['confirm' => __('Are you sure?'), 'class' => 'btn btn-danger btn-sm']); ?>                                                          </div>
                </div>
            </div>
        </div>
    </div>
