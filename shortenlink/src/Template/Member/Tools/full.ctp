...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __("If you have a website with 100's or 1000's of links you want to change over to {0} then please use the script below.", get_option('site_name')) ?></p>
...
<script src='<?= $this->Url->build('/', true); ?>js/full-page-script.js'></script>
        ...
        <p><?= __("Or if you wish to change every link to {0} on your website (without stating exactly which domains) please use the following code.", get_option('site_name')) ?></p>
