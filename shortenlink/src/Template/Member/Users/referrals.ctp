...
<div class="box box-default box-solid">
    <div class="box-body">
        <p><?= __('The {0} referral program is a great way to spread the word of this great service and to earn even more money with your short links! Refer friends and receive {1}% of their earnings for life!', [h(get_option('site_name', '')), h(get_option('referral_percentage', '20'))]) ?></p>
