...
<p>
    <a href="<?php echo $this->Url->build('/', true); ?>auth/users/forgot-password/<?php echo $username; ?>/<?php echo $activation_key; ?>"><?php echo $this->Url->build('/', true); ?>auth/users/forgot-password/<?php echo $username; ?>/<?php echo $activation_key; ?></a>
</p>
