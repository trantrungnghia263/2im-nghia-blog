...
<?php if (version_compare(PHP_VERSION, '5.6.0') < 0) : ?>
    <div class="alert alert-danger" role="alert">
        <?= __("Our script will work only on PHP <b>5.6.0</b> or higher starting from the next updates so please ask your hosting company to upgrade it for you as soon as possible.") ?>
    </div>
<?php endif; ?>

<?= $this->Form->create($options, ['id' => 'form-settings', 'onSubmit' => "save_settings.disabled=true; save_settings.innerHTML='" . __('Saving ...') . "'; return true;"]); ?>
        ...
        <div role="tabpanel" id="payment" class="tab-pane fade in">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                    <span class="help-block"><?= __("You can use these placeholders [campaign_id], [campaign_price], [campaign_visitors]") ?></span>
                </div>
            </div>
